...
.. math::
    \phi_{smooth}(\mathbf{m}) =  \alpha_x ||W_x G_x(\mathbf{m}-\color{blue}{\mathbf{m}_0})||^q + \alpha_y ||W_y G_y(\mathbf{m}-\color{blue}{\mathbf{m}_0})||^q + \alpha_z ||W_z G_z(\mathbf{m}-\color{blue}{\mathbf{m}_0})||^q
    :label: Smoothness5
