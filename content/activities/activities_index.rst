...
Each of these activities are a bit open-ended. This is purposely intended. If we give step-by-step instructions, it can be too easy. That being said, step-by-step instructions are available within this cookbook. Use the search bar to find what you are looking for, check out the :ref:`recipes <recipe_index>`, or browse through the :ref:`general functionality <generalFunctionality_index>` or :ref:`importation <import_index>` sections.
